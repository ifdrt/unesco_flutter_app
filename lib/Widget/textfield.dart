...
class TxFild extends StatefulWidget {
  ...
  State<StatefulWidget> createState() =>
      _TxFildState(title, icon, tcontroller, enable, type, msg,
          radius: this.radius,
...
class _TxFildState extends State<TxFild> {
  ...
  _TxFildState(
      this.title, this.icon, this.tcontroller, this.enable, this.type, this.msg,
      {this.onChange,
      this.radius,
      this.bordercolor,
      this.bkColor,
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      onTap: onClick,
      onChanged: (dynamic a) => onChange != null ? onChange!(a) : null,
      readOnly: readonly!,
